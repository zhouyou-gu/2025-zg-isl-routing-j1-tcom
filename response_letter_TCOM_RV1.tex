...
We have revised the manuscript to address the specific comments from Reviewers 1 and 3, which are detailed in the attached response letters. The key changes include clarifications on the assumptions and scope of our model, a more rigorous complexity analysis with a step-by-step reduction, an expanded baseline comparison in the simulations, and a focused writing cleanup to improve clarity. We believe that these revisions have significantly strengthened the manuscript and addressed the concerns raised by the reviewers. We have also carefully proofread the manuscript to correct any typographical errors and improve the overall presentation. Furthermore, we hope that the revised manuscript will now meet the standards for publication in IEEE Transactions on Communications, and we look forward to your feedback. The revised text is highlighted in blue for easy reference.
