...
Fig. \ref{fig:constellation_simulation_1000_compare} shows the constellations with $I=1000$, the uneven distribution of population density and ground gateway (GW) locations, which emphasizes the need to account for these factors in our study.
