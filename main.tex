...
\begin{rem}
\blue{The reduction in Proposition~\ref{prop:np_hardness} fixes the combinatorial snapshot input and proves hardness for the resulting fixed-snapshot abstract decision problem, rather than deriving those objects from the underlying geometry, field of regard constraints, distance thresholds, and traffic-pair construction rules.
